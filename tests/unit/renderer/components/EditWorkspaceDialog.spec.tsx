...
describe('EditWorkspaceDialog', () => {
  it('renders with workspace name pre-filled', () => {
    render(<EditWorkspaceDialog workspace={ws as any} onClose={vi.fn()} />)
    expect(screen.getByDisplayValue('My Work')).toBeTruthy()
  })

  it('calls onClose when Cancel is clicked', () => {
    const onClose = vi.fn()
    render(<EditWorkspaceDialog workspace={ws as any} onClose={onClose} />)
  ...
  it('renders color swatches', () => {
    const { container } = render(<EditWorkspaceDialog workspace={ws as any} onClose={vi.fn()} />)
