...
export default defineWorkspace([
  {
    ...
    test: {
      ...
      include: [
        ...
        'extensions/remote-control/tests/**/*.spec.ts',
        'extensions/remote-control/tests/**/*.spec.tsx',
        'extensions/remote-control/tests/**/*.spec.js',
        'extensions/task-vault/tests/**/*.spec.ts',
        'extensions/task-vault/tests/**/*.spec.tsx',
        'extensions/task-vault/tests/**/*.spec.js',
