...
function activate(api) {
  ...
  // ── v1.2.0 API surfaces (uncomment to activate) ──────────────────────────

  // TODO: Register a global (system-level) keyboard shortcut
  // disposables.push(
  //   api.globalShortcut.register('CmdOrCtrl+Shift+F12', () => {
  //     api.notifications.showToast('info', '${name} global shortcut triggered')
  //   })
  // )

  // TODO: Register a permanent global tab in the app tab bar
  // disposables.push(
  ...
  // TODO: Read workspace list
  // const workspaces = api.workspace.list()
  // console.log('[${name}] workspaces:', workspaces.map((w) => w.name))
  // disposables.push(api.workspace.onDelete((id) => console.log('[${name}] workspace deleted:', id)))

  // TODO: Open an auxiliary window
  // api.window.openAuxiliary('${id}-view', { param: 'value' })

  // TODO: Create a persistent notification with action buttons
  // disposables.push(
  //   api.notifications.createNotification({
  //     type: 'info',
  //     title: '${name} is ready',
  //     message: 'Click an action to get started.',
  //     actions: [
  //       { id: 'open', label: 'Open', handler: () => { /* ... */ } },
  //       { id: 'dismiss', label: 'Dismiss', handler: () => { /* noop */ } },
  //     ],
  //   })
  // )
}
...
function main(argv) {
  ...
  console.log(`  src/index.js  — main-process entry with all v1.2.0 API stubs`)
  console.log(``)
