...
export function getSpeckitAPI(): SpeckitAPI {
  ...
  return {
    fileWrite: (payload) =>
      bridge.invoke('foundry:file-write', payload) as Promise<{ ok: true } | { error: string }>,
    pilotState: (payload) =>
      bridge.invoke('foundry:pilot-state', payload) as Promise<
        { state: PilotState } | { error: string } | { notFound: true }
      >,
    phaseApprove: (payload) =>
      bridge.invoke('foundry:phase-approve', payload) as Promise<
        { state: PilotState } | { error: string }
      >,
    phaseRevoke: (payload) =>
      bridge.invoke('foundry:phase-revoke', payload) as Promise<
        { state: PilotState } | { error: string }
      >,
    artifactRead: (payload) =>
      bridge.invoke('foundry:artifact-read', payload) as Promise<
        { current: string | null; approved: string | null } | { error: string }
      >,
    historyLoad: (payload) =>
      bridge.invoke('foundry:history-load', payload) as Promise<
        { entries: HistoryEntry[] } | { error: string }
      >,
    phaseSkip: (payload) =>
      bridge.invoke('foundry:phase-skip', payload) as Promise<
        { state: PilotState } | { error: string }
      >,
    phaseUnskip: (payload) =>
      bridge.invoke('foundry:phase-unskip', payload) as Promise<
        { state: PilotState } | { error: string }
      >,
    ticketList: () =>
      bridge.invoke('foundry:ticket-list', {}) as Promise<
        { tickets: Ticket[] } | { error: string }
      >,
    runCancel: (payload) =>
      bridge.invoke('foundry:run-cancel', payload) as Promise<
        { ok: true; state?: PilotState } | { error: string }
      >,
    openPr: (payload) =>
      bridge.invoke('foundry:open-pr', payload) as Promise<{ prUrl: string } | { error: string }>,
    checkinDecision: (payload) =>
      bridge.invoke('foundry:checkin-decision', payload) as Promise<
        { ok: true } | { error: string }
      >,
    selfReviewRead: (payload) =>
      bridge.invoke('foundry:self-review-read', payload) as Promise<
        { result: SelfReviewResult } | { notFound: true; error: string } | { error: string }
      >,
    phaseRequestChanges: (payload) =>
      bridge.invoke('foundry:phase-request-changes', payload) as Promise<
        { state: PilotState } | { error: string }
      >,
    phaseComment: (payload) =>
      bridge.invoke('foundry:phase-comment', payload) as Promise<
        { ok: true; state: PilotState } | { error: string }
      >,
    cardList: (payload) =>
      bridge.invoke('foundry:card-list', payload) as Promise<
        { cards: CardSummary[] } | { error: string }
      >,
    cardCreate: (payload) =>
      bridge.invoke('foundry:card-create', payload) as Promise<
        { featureDir: string } | { error: string; message?: string }
      >,
    cardUpdate: (payload) =>
      bridge.invoke('foundry:card-update', payload) as Promise<
        { ok: true } | { error: string; message?: string }
      >,
    cardMove: (payload) =>
      bridge.invoke('foundry:card-move', payload) as Promise<
        { ok: true } | { error: string; message?: string }
      >,
    cardHandoff: (payload) =>
      bridge.invoke('foundry:card-handoff', payload) as Promise<
        { ok: true; dispatched: true; queued: boolean } | { error: string; message?: string }
      >,
    cardReset: (payload) =>
      bridge.invoke('foundry:card-reset', payload) as Promise<
        { ok: true; state: PilotState } | { error: string }
      >,
    cardComment: (payload) =>
      bridge.invoke('foundry:card-comment', payload) as Promise<
        { comment: CardComment } | { error: string; message?: string }
      >,
    commentList: (payload) =>
      bridge.invoke('foundry:comment-list', payload) as Promise<
        { comments: CardComment[] } | { error: string }
      >,
    runOutputRead: (payload) =>
      bridge.invoke('foundry:run-output-read', payload) as Promise<
        { lines: string[] } | { error: string }
      >,
    runReply: (payload) =>
      bridge.invoke('foundry:run-reply', payload) as Promise<{ ok: true } | { error: string }>,
    permissionsList: () =>
      bridge.invoke('foundry:permissions-list', {}) as Promise<{ pending: PendingAskView[] }>,
    permissionResolve: (payload) =>
      bridge.invoke('foundry:permission-resolve', payload) as Promise<{
        ok: boolean
        reason?: string
      }>,
    permissionHandBack: (payload) =>
      bridge.invoke('foundry:permission-hand-back', payload) as Promise<{ ok: boolean }>,
    supervisionSnapshot: () =>
      bridge.invoke('foundry:supervision-snapshot', {}) as Promise<SupervisionSnapshot>,
    modelsList: () =>
    ...
    modelSet: (payload) =>
      bridge.invoke('foundry:model-set', payload) as Promise<{
        ok?: boolean
        selected?: string
        error?: string
      }>,
    stallsList: () =>
      bridge.invoke('foundry:stalls-list', {}) as Promise<{
        firings: StallFiringView[]
        shadowMode: boolean
      }>,
    feedList: () =>
      bridge.invoke('foundry:feed-list', {}) as Promise<{
        entries: FeedEntryView[]
        mutes: MuteRuleView[]
      }>,
    feedDismiss: (payload) =>
      bridge.invoke('foundry:feed-dismiss', payload) as Promise<{ ok: boolean }>,
    feedMute: (payload) =>
      bridge.invoke('foundry:feed-mute', payload) as Promise<{ mutes: MuteRuleView[] }>,
    feedUnmute: (payload) =>
      bridge.invoke('foundry:feed-unmute', payload) as Promise<{ mutes: MuteRuleView[] }>,
    feedDigest: (payload) => bridge.invoke('foundry:feed-digest', payload) as Promise<DigestView>,
    reviewHunks: (payload) =>
      bridge.invoke('foundry:review-hunks', payload) as Promise<{
        files: HunkFileView[] | null
        complete: boolean
        fullReject?: boolean
      }>,
    reviewDecideHunk: (payload) =>
      bridge.invoke('foundry:review-decide-hunk', payload) as Promise<{ ok: boolean }>,
    reviewApply: (payload) =>
      bridge.invoke('foundry:review-apply', payload) as Promise<{
        ok: boolean
        reverted: number
        error: string | null
      }>,
    reviewDone: (payload) =>
      bridge.invoke('foundry:review-done', payload) as Promise<{ ok: boolean }>,
    runTerminal: (payload) =>
      bridge.invoke('foundry:run-terminal', payload) as Promise<{ ok: boolean }>,
    runTranscript: (payload) =>
      bridge.invoke('foundry:run-transcript', payload) as Promise<{
        lines: TranscriptLineView[]
      }>,
    runInterrupt: (payload) =>
      bridge.invoke('foundry:run-interrupt', payload) as Promise<{ ok: boolean }>,
    runRedirect: (payload) =>
      bridge.invoke('foundry:run-redirect', payload) as Promise<{ ok: boolean }>,
    runStop: (payload) => bridge.invoke('foundry:run-stop', payload) as Promise<{ ok: boolean }>,
    runDiscard: (payload) =>
      bridge.invoke('foundry:run-discard', payload) as Promise<{ ok: boolean }>,
    reviewAdvance: (payload) =>
      bridge.invoke('foundry:review-advance', payload) as Promise<{ step: ReviewStepView | null }>,
    reviewIntent: (payload) =>
      bridge.invoke('foundry:review-intent', payload) as Promise<{
        intent: IntentReviewView | null
      }>,
    lanes: (payload) =>
      bridge.invoke('foundry:lanes', payload) as Promise<{ lanes: LaneViewJson[] }>,
    laneMayMerge: (payload) =>
      bridge.invoke('foundry:lane-may-merge', payload) as Promise<{
        allowed: boolean
        reason: string | null
        blockingLane: number | null
      }>,
    artifactList: (payload) =>
      bridge.invoke('foundry:artifact-list', payload) as Promise<
        { artifacts: ArtifactRef[] } | { error: string }
      >,
    knowledgeSearch: (payload) =>
      bridge.invoke('foundry:knowledge-search', payload) as Promise<
        { results: KnowledgeRef[] } | { error: string }
      >,
    onStateChanged: (handler) => bridge.on('foundry:state-changed', handler),
    onPermissionsChanged: (handler) => {
      ...
      const raised = bridge.on('foundry:permission-requested', () => handler())
      const answered = bridge.on('foundry:permission-resolved', () => handler())
      return () => {
        raised()
        answered()
      }
    },
    onRunOutput: (handler) => bridge.on('foundry:run-output', handler as (data: unknown) => void),
    onPaletteGoto: (handler) =>
      bridge.on('foundry:palette-goto', handler as (data: unknown) => void),
    onCheckinReady: (handler) =>
      bridge.on('foundry:checkin-ready', handler as (data: unknown) => void),
  }
}
