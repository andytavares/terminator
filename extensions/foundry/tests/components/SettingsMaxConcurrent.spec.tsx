...
describe('SettingsView — max concurrent runs', () => {
  ...
  it('defaults to 3 and writes changes to the core settings bridge', async () => {
    ...
    await waitFor(() => expect(set).toHaveBeenCalledWith('terminator.foundry.maxConcurrentRuns', 5))
  })
  ...
  it('coerces values below 1 up to 1', async () => {
    ...
    await waitFor(() => expect(set).toHaveBeenCalledWith('terminator.foundry.maxConcurrentRuns', 1))
  })
  ...
  it('defaults log retention to 30 days and persists changes', async () => {
    ...
    await waitFor(() => expect(set).toHaveBeenCalledWith('terminator.foundry.logRetentionDays', 7))
  })
})
