...
export function GlobalSettings(): JSX.Element {
  ...
  return (
    <>
      <div className="settings-section">
        ...
        <div className="settings-section__field">
          ...
          <span className="settings-section__hint">
            When enabled, you are asked to name each new terminal before it opens. Leave blank to
            use the default &ldquo;Terminal N&rdquo; name.
          </span>
        </div>
        ...
        <div className="settings-section__field">
          ...
          />
          <span className="settings-section__hint">
            Where new git worktrees are created. Leave empty for the default (
            <code>.worktrees</code> inside the repo).
          </span>
        </div>
      ...
      <QuickActionsSettings scope="global" />
    </>
  )
}
