...
export const ELECTRON_API_MANIFEST: readonly ChannelSpec[] = [
  ...
  {
    path: 'supervision.removeIntake',
    kind: 'invoke',
    channel: 'supervision:removeIntake',
    remote: 'omit',
  },
  {
    path: 'supervision.pullFromLinear',
    kind: 'invoke',
    channel: 'supervision:pullFromLinear',
    remote: 'omit',
  },
  { path: 'supervision.assign', kind: 'invoke', channel: 'supervision:assign', remote: 'omit' },
  {
    path: 'supervision.onWorkItemsChanged',
    kind: 'event',
    channel: 'supervision:workItemsChanged',
    remote: 'omit',
  },
  {
  ...
  {
    path: 'supervision.stopSession',
    kind: 'invoke',
    channel: 'supervision:stopSession',
    remote: 'omit',
  },
  {
